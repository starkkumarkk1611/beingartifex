...
abstract class Event_manager_repeater_metabox {
        ...
        <div class="<?php echo esc_attr( $class ); ?>">
            ...
            <div class="etn-meta">
                <input autocomplete="off" class="etn-form-control" type="<?php echo esc_attr( $item['type'] ); ?>" name="<?php echo esc_attr( $key ); ?>"
                 id="<?php echo esc_attr( $key ."_".$index ); ?>" value="<?php echo esc_html( $value ); ?>" min="0" step="<?php echo esc_html( $step ); ?>"/>
            </div>
        </div>
        <?php
    }
    ...
    public function get_repeater_text_input( $item, $key, $data ) {
        ...
        $html  =""; 
        $html .= sprintf( '<div class="etn-label-item %s"><div class="etn-label"><label for="%s"> %s : </label><div class="etn-desc">  %s  </div></div><div class="etn-meta"><input autocomplete="off" class="etn-form-control %s" type="%s" name="%s"  value="%s" />', $hide_block ,$key, $item['label'], $item['desc'], $class, $item['type'], $key, $value );
        $html .= "</div></div>";
