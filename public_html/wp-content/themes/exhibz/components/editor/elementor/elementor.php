...
if (defined('ELEMENTOR_VERSION')):
    ...
    class EXHIBZ_Shortcode
    {
        ...
        public function EXHIBZ_shortcode_elements($widgets_manager)
        {
            ...
            $widgets_manager->register_widget_type(new Elementor\Exhibz_MainSlider_Widget());
            ...
            if (class_exists('Wpeventin')) {
                ...
                $widgets_manager->register_widget_type(new Elementor\Exhibz_Creative_Schedule_Tab());
                ...
                $widgets_manager->register_widget_type(new Elementor\Exhibz_Creative_Speaker_Widget());

                require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/exhibz-event-ticket.php';
                $widgets_manager->register_widget_type( new Elementor\Exhibz_Event_Ticket_Widget() );
            }

            require_once EXHIBZ_EDITOR_ELEMENTOR . '/widgets/exhibz-button.php';
            $widgets_manager->register_widget_type(new Elementor\Exhibz_Button_Widget());
